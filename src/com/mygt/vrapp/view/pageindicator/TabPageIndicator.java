 ...
 */
package com.mygt.vrapp.view.pageindicator;
...
public class TabPageIndicator extends HorizontalScrollView implements PageIndicator {
	...
	private static final int[] LL = new int[] {
	        /* 0 */ android.R.attr.layout_marginLeft,
	        /* 1 */ android.R.attr.layout_marginRight,
	    };
    ...
    public TabPageIndicator(Context context, AttributeSet attrs) {
        ...
        tabLeftMargin = a.getDimensionPixelSize(MARGIN_LEFT, 0);
        tabRightMargin = a.getDimensionPixelSize(MARGIN_RIGHT, 0);
        a.recycle();
